...
a.  Usando o parámetro PIP para requerimentos adicionais no docker-compose.yaml (usar apenas para testar providers!):
```yaml
_PIP_ADDITIONAL_REQUIREMENTS: ${_PIP_ADDITIONAL_REQUIREMENTS:- apache-airflow-providers-microsoft-mssql}
```
b.  Ou, criando sua nova imagem customizada com o Dockerfile (Ver arquivo com exemplo):
...
**6. Inicie os conteiners com docker-compose:**
```bash
docker-compose up -d
```
**7. Confira os conteiners rodando:**
```bash
docker ps
```
